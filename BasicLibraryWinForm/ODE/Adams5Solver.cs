...
{
    public class Adams5Solver : OdeSolver
    {
        private Queue<OdeSolution> solutions = new Queue<OdeSolution>();
        private Queue<double> times = new Queue<double>();

        double[] coeffs = new[] { 1901.0 / 720, -1387.0 / 360, 109.0 / 30, -637.0 / 360, 251.0 / 720 };
        ...
        protected override bool SolveInnerStep(double dt)
        {
            ...
            solutions.Enqueue(new OdeSolution(CurrentSolution.Values.Copy()));
