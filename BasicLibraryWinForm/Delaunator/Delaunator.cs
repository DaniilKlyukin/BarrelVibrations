using BasicLibraryWinForm.Delaunator.Models;
...
namespace BasicLibraryWinForm.Delaunator
{
...
#pragma warning disable CS8625 // Литерал, равный NULL, не может быть преобразован в ссылочный тип, не допускающий значение NULL.
        public IEnumerable<IVoronoiCell> GetVoronoiCells(Func<int, Point> triangleVerticeSelector = null)
#pragma warning restore CS8625 // Литерал, равный NULL, не может быть преобразован в ссылочный тип, не допускающий значение NULL.
        {
            if (triangleVerticeSelector == null) triangleVerticeSelector = x => GetCentroid(x);
...
#pragma warning disable CS8604 // Возможно, аргумент-ссылка, допускающий значение NULL.
        public static IEnumerable<IEdge> CreateHull(IEnumerable<Point> points) => points.Zip(points.Skip(1).Append(points.FirstOrDefault()), (a, b) => new Edge(0, a, b)).OfType<IEdge>();
#pragma warning restore CS8604 // Возможно, аргумент-ссылка, допускающий значение NULL.
        ...
        public static Point GetCentroid(Point[] points)
        {
            ...
            if (Math.Abs(accumulatedArea) < 1E-10f)
                return new Point();

            accumulatedArea *= 3f;
            return new Point(centerX / accumulatedArea, centerY / accumulatedArea, 0);
        }

        public static (double, double) GetCentroidCoordinates(Point[] points)
        {
            double accumulatedArea = 0.0f;
            double centerX = 0.0f;
            double centerY = 0.0f;
...
#pragma warning disable CS8625 // Литерал, равный NULL, не может быть преобразован в ссылочный тип, не допускающий значение NULL.
        public void ForEachVoronoiCell(Action<IVoronoiCell> callback, Func<int, Point> triangleVertexSelector = null)
#pragma warning restore CS8625 // Литерал, равный NULL, не может быть преобразован в ссылочный тип, не допускающий значение NULL.
        {
